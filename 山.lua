...
tab2.newButton("湘脚本", "", function()
    loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/d174e519ddbc5dedee05368c178c5dff.lua"))()
end)

tab2.newButton("即将推出", "", function()
    print('Hello!')
end)
